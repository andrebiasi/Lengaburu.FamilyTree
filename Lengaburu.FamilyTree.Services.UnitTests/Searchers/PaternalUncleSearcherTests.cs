...
{
    public class PaternalUncleSearcherTests
    {
        [Fact]
        public void ShouldReturnEmptyListWhenNotFound()
        {
            ...
            var searcher = new PaternalUncleSearcher(familyRepositoryMock.Object);
        ...
        [Fact]
        public void ShouldReturnParentalUnclesWhenFound()
        {
            var person = new Person("Bob", Gender.Male);
